	...
	<body>
		...
		<div id="show-author" class="content scaffold-show" role="main">
			...
			<ol class="property-list author">
				...
				<g:if test="${authorInstance?.yearsOfExperience}">
				<li class="fieldcontain">
					<span id="yearsOfExperience-label" class="property-label"><g:message code="author.yearsOfExperience.label" default="Years Of Experience" /></span>
					
						<span class="property-value" aria-labelledby="yearsOfExperience-label"><g:fieldValue bean="${authorInstance}" field="yearsOfExperience"/></span>
