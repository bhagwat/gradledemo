		...
		<div id="list-author" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="yearsOfExperience" title="${message(code: 'author.yearsOfExperience.label', default: 'Years Of Experience')}" />
				...
				<g:each in="${authorInstanceList}" status="i" var="authorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: authorInstance, field: "yearsOfExperience")}</td>
